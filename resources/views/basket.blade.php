                  ...
                  <div class="tp-search-form">
                     ...
                     <form action="cart.html#">
                        ...
                        <div class="tp-search-category">
                           <span>Search by : </span>
                           <a href="cart.html#">Men, </a>
                           <a href="cart.html#">Women, </a>
                           <a href="cart.html#">Children, </a>
                           <a href="cart.html#">Shirt, </a>
                           <a href="cart.html#">Demin</a>
                        </div>
                     </form>
                  </div>
               </div>
             ...
             <div class="cartmini__top-wrapper">
                 ...
                 <div class="cartmini__widget">
                     <div class="cartmini__widget-item">
                         ...
                         <a href="cart.html#" class="cartmini__del"><i class="fa-regular fa-xmark"></i></a>
                     </div>
                 </div>
                 <!-- for wp -->
                 <!-- if no item in cart -->
               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <h3 class="breadcrumb__title">Корзина</h3>
                     </div>
                  </div>
               </div>
            </div>
